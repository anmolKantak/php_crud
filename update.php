...
if(isset($_POST['update'])){
    $prod_name = $_POST['firstname'];
       ...
       $sql="UPDATE products SET  prod_name='$prod_name' , prod_img = '$prod_img' ,  prod_price='$prod_price', 
                     prod_cat='$prod_cat' WHERE id='$id'";
		...
		<div class="filable_form_container">
			<div class="form_container_block">
				...
				<ul>
					<li class="fileds">
						<div class="name_fileds">
							...
							<input name="firstname" id="firstname" type="text" value="<?php  echo $row['prod_name'] ;    ?>" /> 
						</div>
					</li>
					<li class="fileds">
						<div class="name_fileds">
							<label>Product Price</label>
							<input name="price" id="price" type="text" value="<?php echo $row['price']    ;      ?>" /> 
						</div>
					</li>
					<li class="fileds">
					...
					<li class="fileds">
						<div class="name_fileds">
							...
							<select name="category" class="select category" id="category">
								<option value="mobile" <?php   if($row['prod_cat']=="mobile")    echo "selected"; ?>>Mobile</option>
								<option value="automobile" <?php  if($row['prod_cat']=="automobile")     echo "selected"  ;   ?>>Automobile</option>
							</select> 
						</div>
					</li>
				</ul>
				<div class="next_btn_block">
					<div class="next_btn">
               <!-- <a href="#" class="createp" id="createp">Submit  <span><img src="images/small_triangle.png" alt="small_triangle"> </span></a> -->
                        <button type="submit"class="update"  name="update">Submit</button>
					</div>
                </div>
               </form>
			</div>
