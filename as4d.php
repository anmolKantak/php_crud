				...
				<table width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center"><img src="fs/<?php    echo $row['2'] ;    ?>" style="width:80px; height:auto;"></td>
							<td><?php echo $row['3'];    ?></td>
							<td><?php echo $row['4'];   ?></td>
							
							<td>
								<div class="buttons">
								  <button class="btn btn_edit"><a href="update.php?uid=<?php echo  $row['0'] ;   ?>" >Update</a></button>
								  <button class="btn btn_delete"><a href="delete.php?did=<?php   echo $row['0'] ; ?>">Delete</a></button>
								</div>								
							</td>
								 <?php } ?>
								 </tr>		 
